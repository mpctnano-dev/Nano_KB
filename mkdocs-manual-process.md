...
`md_file_images/` stores screenshots and visual references used inside the Markdown guides.
...
4. Add screenshots to `md_file_images/` if the guide needs visual proof.
