...
Now, you can update the visual content blocks sequentially by following the steps detailed in [05-update-ptap-and-intel-chips-pages.md](../workforce/05-update-ptap-and-intel-chips-pages.md):
